...
$total_rows = $conn->query("SELECT COUNT(*) AS total FROM suppliers")->fetch_assoc()['total'];
$total_pages = ceil($total_rows / $limit);

$result = $conn->query("SELECT * FROM suppliers ORDER BY id DESC LIMIT $limit OFFSET $offset");
$counter = $offset + 1; 
?>
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <small class="text-muted">Manage supplier information</small>
                </div>
                        ...
                        <?php if($result->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a href="delete.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-outline-danger action-btn" title="Delete" onclick="return confirm('Delete this supplier?');">
